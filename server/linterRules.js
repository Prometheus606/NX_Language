// Liste der Regeln mit Regex, Severity & Fehlermeldung
  ...
  const rules = [
    ...
    // ❌ Funktionsnamen dürfen keine Sonderzeichen enthalten
    {
        regex: /proc\s+([^\w_]\w*)/,
        severity: 1, 
        message: "Funktionsnamen müssen mit einem Buchstaben oder Unterstrich beginnen",
    },
    ...
    // ⚠️ Warnung: Variablen sollten nicht mit Großbuchstaben beginnen (Best Practice)
    {
        regex: /set\s+[A-Z]\w*/,
        severity: 2, 
        message: "Variablennamen sollten nicht mit Großbuchstaben beginnen (Best Practice)",
    },
